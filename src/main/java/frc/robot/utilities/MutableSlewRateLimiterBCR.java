 ...
 */
public class MutableSlewRateLimiterBCR {
  ...
  /**
   * Creates a new BCRSlewRateLimiter with the given positive and negative rate limits and initial
   * value.
   *
   ...
   */
  public MutableSlewRateLimiterBCR(double positiveRateLimit, double negativeRateLimit, double initialValue) {
  ...
  /**
   * Creates a new BCRSlewRateLimiter with the given positive rate limit and negative rate limit of
   * -rateLimit and initial value.
   *
   * @param rateLimit The rate-of-change limit, in units per second.
   * @param initalValue The initial value of the input.
   * @deprecated Use BCRSlewRateLimiter(double positiveRateLimit, double negativeRateLimit, double
   *     initalValue) instead.
   */
  @Deprecated(since = "2023", forRemoval = true)
  public MutableSlewRateLimiterBCR(double rateLimit, double initalValue) {
   ...
   * @param rateLimit The rate-of-change limit, in units per second.
   */
  public MutableSlewRateLimiterBCR(double rateLimit) {
